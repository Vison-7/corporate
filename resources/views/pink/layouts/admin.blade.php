<!DOCTYPE html>
    ...
    <head>
       ...
       <!-- FONTs -->
        ...
        <script type="text/javascript" src="{{asset(env('THEME') )}}/js/ul-drop.js"></script>
    ...
    <!-- START BODY -->
    <body class="no_js responsive {{(Route::currentRouteName() == 'main') || (Route::currentRouteName() == 'portfolios.index') ? 'page-template-home-php' : ''}} stretched">
                ...
                <div id="header" class="group">
                    ...
                    <div class="group inner">
                        ...
                        <div id="logo" class="group">
                            <a href="{{route('main')}}" title="Pink Rio"><img src="{{asset(env('THEME') )}}/images/logo.png" title="Pink Rio" alt="Pink Rio" /></a>
                        </div>
                        <!-- END LOGO -->
                        
                        <div id="sidebar-header" class="group">
                            <div class="widget-first widget yit_text_quote">
                                <blockquote class="text-quote-quote">Тестовое задание на позицию младший РНР-разработчик</blockquote>
                                <cite class="text-quote-author">Владимир Мартынов</cite>
                            </div>
                        </div>
